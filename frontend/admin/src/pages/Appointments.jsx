    ...
    <div className="w-full p-4">
      ...
      <div className="flex flex-col gap-4 bg-white border border-gray-200 shadow-md text-sm rounded-lg max-h-[80vh] overflow-y-scroll scrollbar-hide">
        ...
        {appointments.map((appointment, index) => (
          <div
            className={`flex flex-col md:flex-row justify-between items-start md:items-center p-3 rounded-lg hover:bg-gray-100 transition-colors ${
          ...
          >
            ...
            <p
              className={`w-1/6 text-center font-semibold ${
