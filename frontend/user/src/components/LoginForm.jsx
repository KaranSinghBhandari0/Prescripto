...
export default function LoginForm({ formData, handleFormToggle, handleChange, isLogin, handleSubmit, submitting }) {
  ...
  return (
    ...
    >
      ...
      {!isLogin && (
        <div className="relative">
          <input
            ...
            className={`text-sm text-slate-700 border border-[2.3px] w-full rounded p-2 outline-blue-500 transition-all focus:border-blue-500 ${
      ...
      <button
        type="submit"
        className={`w-[50%] rounded-xl py-2 text-white text-xl font-semibold mx-auto flex justify-center gap-3 items-center ${
