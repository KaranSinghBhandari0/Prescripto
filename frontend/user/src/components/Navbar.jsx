  ...
  return (
    <div className="max-w-7xl mx-auto border-b border-slate-400 flex justify-between py-4 px-2 items-center">
      ...
      <div className="md:flex gap-6 align-middle hidden">
        ...
        <button className="hover:border-b-2 hover:border-blue-700" onClick={() => window.open('https://hospital-management-admin.vercel.app', '_blank', 'noopener,noreferrer')}>Admin</button>
      </div>
        ...
        {!user ? (
          ...
          <div className="flex items-center gap-2 cursor-pointer group relative">
            ...
            <div className="absolute top-2 right-0 pt-14 text-base group-hover:block z-20 hidden">
              <div className="bg-stone-100 min-w-40 rounded-xl flex flex-col gap-2 p-4">
